		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="form-group col-lg-12">
				    ...
				    <input name="boardTITLE" class="form-control" placeholder="글 제목" maxlength="50" value="<%= board.getBoardTITLE() %>">
				</div>
				...
				<div class="form-group col-lg-12">
				    ...
				    placeholder="글 내용" maxlength="2048"><%= board.getBoardCONTENT() %></textarea>
				</div>
				...
				<input type="submit" class="btn btn-dark mt-3 ml-3" value="글수정">
